...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#08192D" ,height: "120px"}}>
            <div className="headertext">
              <label><LineChartOutlined style={{color:"#FC0254",fontSize:"40px", marginRight:"10px"}}/><h3 style={{color:"#FFFFFF"}}>Numerical Method</h3></label>
            </div>
          </Header>
          <Layout>
            <Header className="header" style={{ backgroundColor:"#08192D" ,color:"#e89a3c"}}>
              <Menu theme="light" mode="horizontal" style={{color:"#4C4C4C"}} >
          ...
          <Footer style={{ backgroundColor: "#08192D", minHeight: 120 }}>
