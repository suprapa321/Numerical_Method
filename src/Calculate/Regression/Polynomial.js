    ...
    render() {
        return (
            <div style={{ padding: "30px" }}>
                <h2 style={{ color: "black", fontWeight: "bold" , textAlign: "center"}}>Polynomial Regression</h2>
                        ...
                        >
                            {this.state.showInputForm &&
                                <div>
                                    ...
                                    <h2 style={{color: "#FFFFFFFF", fontSize:"24px" }}>Order(m)</h2><Input size="large" name="m" style={InputStyle}></Input>
