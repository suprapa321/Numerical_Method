    ...
    render() {
        return (
            <div style={{padding: "30px" }}>
                <h2 style={{ color: "black", fontWeight: "bold" , textAlign: "center"}}>Multiple Linear Regression</h2>
                        ...
                        >
                            {this.state.showInputForm &&
                                <div>
                                    <h2 style={{color: "#FFFFFFFF", fontSize:"24px" }}>Number of X</h2><Input size="large" name="X" style={InputStyle}></Input>
